...
* `card_success_url` - страница, на которую будет перенаправлен пользователь при успешном платеже
* `card_failure_url` - страница, на которую будет перенаправлен пользователь при ошибке во время оплаты
